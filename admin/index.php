...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>HIMASI Portal | Dashboard</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.php" class="logo"><span>HIMASI<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
                            ...
                            <a href="manage-posts.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Total Articles</p>
