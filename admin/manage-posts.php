...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>HIMASI Portal | Manage Posts</title>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-colored table-centered table-inverse m-0">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $query = mysqli_query($con, "select tblposts.id as postid,tblposts.PostTitle as title,tblcategory.CategoryName as category,tblsubcategory.Subcategory as subcategory,tblusers.nama as author from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId left join tblusers on tblusers.id=tblposts.id_user where tblposts.Is_Active=1 ");
